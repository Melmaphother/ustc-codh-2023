...
#
# Generated by export_simulation on Fri May 19 16:02:21 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './dist_mem_reginfo.sh' script.

./dist_mem_reginfo.sh -reset_run
...
./dist_mem_reginfo.sh -noclean_files

For more information on the script, please type './dist_mem_reginfo.sh -help'.
